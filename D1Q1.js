...
var officials = ["Manager", "General Manager", "Admin", "Transport Officer"];
officials.forEach(function (official) {
    if (official.toLowerCase() == "admin") {
        console.log("Hellow ".concat(official, " you are the main Administrator of our Organization"));
    }
    else {
        console.log("Hellow ".concat(official, ", how r u??"));
    }
});
